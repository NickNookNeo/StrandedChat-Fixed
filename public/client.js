$(async function() {
  ...
  var version = '1.4';
  var whatsNew = `
    - among us john has been demoted
    - NickNookNeo loves nook's cranny now. 'always have' -NickNookNeo
    - Mr. Nook from animal crossing wants to meet NickNookNeo.`;
  var info = `
  <a href="https://google.com" target="_blank">Other Projects</a>
  <br><br>
  ...
  function showRules() {
    ...
    Swal.fire({
      title: 'Rules',
      html: `<rules style="list-style-type: &quot;👉&quot;;text-align:left;"><li>please don't put spaces in your name.</li><li> Don't try to abuse any exploits.</li><li> Don't spam.</li><li> Use common sense.</li></rules><br>`,
      icon: 'info',
      width: '35%'
    })
  }
  function showFaq() {
    ...
    Swal.fire({
      title: 'FAQ',
      html: `Q: <i>Who created this?</i><br>A: someone other than me 😂<br><br>Q: <i>Why was this created?</i><br>A: I have my reasons...<br><br>Q: <i>How can I submit a suggestion?</i><br>A: There is a suggestion form in the strandedchat's taskbar.`,
      icon: 'info',
      width: '30%'
    })
  }
